...
/** All districts for every Indian state (unknown ones fall back to the regional model) */
...
/** Every state now has district data; Telangana also has deep API hierarchy */
export const STATES_WITH_AREAS: ReadonlySet<string> = new Set(Object.keys(STATE_DISTRICTS));
